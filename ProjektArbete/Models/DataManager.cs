    ...
    public class DataManager
    {
        ...
        internal QuestionsVM[] Questions()
        {
            List<QuestionsVM> quest = new List<QuestionsVM>
            {
                ...
                new QuestionsVM {Question="Hur har ni fått fram siffrorna?", Answere="All data kommer ifrån Sveriges riksdag. Närvaron räknas ut från voteringar i riksdagen. En riksdagsledamot kan rösta ja, nej eller avstå, är man inte på plats så får man frånvaro.", Source="http://data.riksdagen.se"},
